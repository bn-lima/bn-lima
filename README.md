...
- 🔐 Authentication systems (custom auth & token flows)  
- 🗄️ PostgreSQL database modeling  
- 🔄 REST API development with Django REST Framework  
- 🧩 Clean project structure & best practices  
- 📦 Migration handling & database management  
- 🧠 Constant learning & technical evolution  
- 🚀 Building foundations for long-term scalable systems  
